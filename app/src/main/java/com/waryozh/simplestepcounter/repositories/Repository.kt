...
object Repository {
    ...
    private var today: WalkDay = initToday()

    private fun initToday(): WalkDay {
    ...
    // TODO make this suspend function; will need to create CoroutineScope in StepCounter service and pass it to this repo
